...
const EnhancedProfileSection: React.FC<EnhancedProfileSectionProps> = ({
  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-slate-50 via-white to-amber-50/20 min-h-screen overflow-y-auto">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-techgold via-amber-500 to-amber-600 h-48 relative">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-6 mb-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="relative group">
              ...
              {profile.is_verified && (
                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-techgold rounded-full flex items-center justify-center border-2 border-white">
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div>
                  ...
                  {profile.member_label && (
                    <span className="inline-flex items-center gap-1 mt-2 px-3 py-1 bg-amber-100 text-amber-700 text-sm font-medium rounded-full">
              ...
              <div className="flex flex-wrap gap-4 mt-4 text-sm text-slate-600">
                ...
                {profile.website && (
                  <a
                    ...
                    className="flex items-center gap-1 text-techgold hover:underline"
                  >
            ...
            <div className="mt-6 pt-6 border-t border-slate-200">
              {editMode ? (
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl resize-none focus:ring-2 focus:ring-techgold focus:border-transparent"
                  rows={3}
                />
              ) : (
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center">
                      <Mail className="w-5 h-5 text-techgold" />
                    </div>
                    <div className="flex-1">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-techgold focus:border-transparent"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-techgold focus:border-transparent"
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="p-1 bg-techgold text-white rounded-lg hover:bg-techgold-dark"
                    >
