...
const TopicChatWindow = ({ topic, currentUserId, onClose }: TopicChatWindowProps) => {
  ...
  return (
    <>
      ...
      <div 
        className="fixed bottom-0 left-0 right-0 md:inset-auto md:bottom-4 md:right-4 w-full md:w-[450px] h-[75vh] md:h-[600px] rounded-t-2xl md:rounded-2xl shadow-2xl flex flex-col z-[100] overflow-hidden"
        style={{ 
