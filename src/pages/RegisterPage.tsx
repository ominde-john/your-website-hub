  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md shadow-2xl border border-white/20 bg-white/95 backdrop-blur-xl relative z-10">
        {/* Top accent bar */}
        <div className="h-1 bg-gradient-to-r from-techgold via-techblue to-techgold rounded-t-lg" />
        
        <CardHeader className="text-center pb-2 pt-5">
          {/* Logo with glow effect */}
          <div className="relative mx-auto mb-3">
            <div className="absolute inset-0 bg-techgold/30 rounded-full blur-xl scale-150" />
            <div className="h-16 w-16 rounded-full bg-[#000000] flex items-center justify-center p-1 relative shadow-xl ring-2 ring-techgold/20">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2">
            Join Teksoft
            <Sparkles className="h-4 w-4 text-techgold" />
          </CardTitle>
        ...
        <CardContent className="pt-1 pb-5 px-6">
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-techblue transition-colors" />
                  <Input
                    id="firstName"
                    name="firstName"
                    ...
                    className="pl-10 h-9 text-sm border-gray-200 focus:border-techblue focus:ring-techblue/20 transition-all"
                    required
                  />
                </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <AtSign className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-techblue transition-colors" />
                <Input
                  id="username"
                  name="username"
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-techblue transition-colors" />
                <Input
                  id="email"
                  name="email"
                  type="email"
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-techblue transition-colors" />
                <Input
                  id="password"
                  name="password"
                  type="password"
            ...
            <Button
              type="submit" 
              className="w-full h-9 text-sm font-semibold bg-gradient-to-r from-techblue to-techblue-dark hover:from-techblue-dark hover:to-techblue text-white shadow-lg shadow-techblue/25 transition-all duration-300 hover:shadow-xl hover:shadow-techblue/30 hover:scale-[1.02]"
              disabled={loading}
            >
              {loading ? (
                <>
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-9 text-sm font-medium border-gray-300 hover:bg-gray-50 transition-all"
          ...
          <div className="mt-5 text-center">
            ...
            <Link 
              to="/auth" 
              className="mt-3 inline-flex items-center gap-2 text-techblue hover:text-techblue-dark font-semibold text-sm transition-all hover:gap-3"
            >
