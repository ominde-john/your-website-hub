...
const ContactPage = () => {
  ...
  return (
    <div>
      <PageHeader title="Contact Us" description="Get in touch with the Tech Team community" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4"><Mail className="h-6 w-6 text-techblue" /><div><h3 className="font-semibold">Email</h3><p className="text-gray-600">info@techteam.org</p></div></div>
