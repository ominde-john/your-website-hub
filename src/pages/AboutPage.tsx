...
const AboutPage = () => {
  ...
  const values = [
    ...
    {
      icon: <UsersRound className="h-8 w-8 text-techgold" />,
      title: "Collaboration",
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Our community brings together developers, designers, data scientists, and tech enthusiasts
                from all backgrounds to share knowledge, build projects, and create meaningful connections.
              </p>
